...
def render_analysis_results(result: dict):
    ...
    st.info(result.get('plain_summary', 'Analysis complete. Review the sections above for details.'))
...
def get_demo_result():
    ...
    return {
        ...
        "financial_terms": [
            ...
            {"type": "Late Payment Penalty", "amount": "2% per month", "details": "On overdue amounts"}
        ],
